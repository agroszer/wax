...
class StyledTextBox(waxobject.WaxObject, stc.StyledTextCtrl):
    ...
    __events__ = {
        ...
        'DoDrop': stc.EVT_STC_DO_DROP,
        'DragOver': stc.EVT_STC_DRAG_OVER,
        'StartDrag': stc.EVT_STC_START_DRAG,
    }
...
language_states = {
    ...
    'ruby': {
        # there are no constants for these in stc.h...
        'default': 0,
        'comment': 1,
        'number': 2,
        'double_quoted_string': 3,
        'single_quoted_string': 4, # not correct?
        'keyword': 5,
        'classname': 8,
        'defname': 9,
        'operator': 10,
        ...
        # not sure yet what these are for...
        'string_eol': 6,
        'foo': 7,
        'bar': 12,
    },
